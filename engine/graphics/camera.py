...
class PseudoCamera:
    ...
    def __str__(self):
        ...
        return f"PseudoCamera || position: {str(self.__position):10}, area: {str(self.area):10}, center: {str(self.center):10}, chunk: {str((int(self.center[0] // singleton.DEFAULT_CHUNK_PIXEL_WIDTH), int(self.center[1] // singleton.DEFAULT_CHUNK_PIXEL_HEIGHT))):10}"
